    ...
    $router->group(['prefix' => 'cash'], function () use ($router){
        ...
        $router->group(['prefix' => 'L'], function() use($router){
            $router->group(['prefix' => 'restock'], function() use($router){
                $router->post('/', 'LRestockController@index');
        ...
        $router->group(['prefix' => 'LVH'], function() use($router){
            ...
            $router->group(['prefix' => 'resources'], function() use($router){
                ...
                $router->post('/getAssortmentInsumos', 'CiclicosController@getAssortmentInsumos');
            ...
            $router->group(['prefix' => 'compare'], function () use ($router){
                ...
                $router->post('/getChangePrices/{wid}', 'CiclicosController@getChangePrices');
