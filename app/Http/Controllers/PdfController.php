  ...
  public function pdf_lapicera_20($products, $isInnerPack){
    ...
    foreach($products as $key => $product){
        for($i=0; $i<$product['copies']; $i++){
            ...
            $this->setImageBackground_area_2(null, $content, $width=37, $height=40, $cols=4, $rows=5, $top_space=-21, $sides_space=11.8, $position=$key+$counter, $top_margin=12.5, $sides_margin=11.6);
        }
    }
