...
class InitSeeder extends Seeder{
    ...
    public function run(){
        ...
        DB::table('modules_app')->insert([
            ...
            ['id'=> 11, 'name'=> 'Configuracion', 'deep'=> 1, 'root'=> 4, 'path'=> 'configuracion'],
            ['id'=> 12, 'name'=> 'Reportes', 'deep'=> 1, 'root'=> 4, 'path'=> 'reportes'],
        ...
        DB::table('permissions')->insert([
            ...
            ['id'=> 13, '_module'=> 7, 'name'=> 'Recibir pedido'],
            ['id'=> 14, '_module'=> 7, 'name'=> 'Finalizar surtido'],
            ['id'=> 15, '_module'=> 7, 'name'=> 'Salida de caja'],
            ['id'=> 16, '_module'=> 7, 'name'=> 'Comenzar a cobrar'],
            ['id'=> 17, '_module'=> 7, 'name'=> 'Visualizar pedidos en proceso'],
            ['id'=> 40, '_module'=> 7, 'name'=> 'Visualizar pedidos levantados'],
            ['id'=> 41, '_module'=> 7, 'name'=> 'Visualizar pedidos por recepción'],
            ['id'=> 42, '_module'=> 7, 'name'=> 'Visualizar pedidos por surtir'],
            ['id'=> 43, '_module'=> 7, 'name'=> 'Visualizar pedidos surtiendo'],
            ['id'=> 44, '_module'=> 7, 'name'=> 'Visualizar pedidos surtidos (por cobrar)'],
            ['id'=> 45, '_module'=> 7, 'name'=> 'Visualizar pedidos en caja'],
            ['id'=> 46, '_module'=> 7, 'name'=> 'Visualizar pedidos finalizados'],
